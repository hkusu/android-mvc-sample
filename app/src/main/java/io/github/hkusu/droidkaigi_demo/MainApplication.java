...
import io.github.hkusu.droidkaigi_demo.fragment.DetailFragment;
...
public class MainApplication extends Application {
    ...
    public void onCreate() {
        ...
        ModelManager.register(ModelManager.ModelList.QIITA_ITEM, new QiitaItemModel());

        // FragmentManager に各Fragmentのクラス名を登録(ここではインスタンス化しない)
        FragmentManager.register(FragmentManager.FragmentList.LIST, ListFragment.class);
        FragmentManager.register(FragmentManager.FragmentList.DETAIL, DetailFragment.class);
